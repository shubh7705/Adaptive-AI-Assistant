...
class ScoringService:
    ...
    def score_model(
        ...
        latency_penalty = (avg_latency / 1000.0) * weights.latency
        
        # 4. Reliability & Load Penalties
        error_rate = metrics.error_rate if metrics else 0.0
        error_penalty = error_rate * 5.0 # Max 5 point penalty for 100% error rate
        ...
        final_score = capability_score + arena_bonus - latency_penalty - cost_penalty - error_penalty - diversity_penalty
